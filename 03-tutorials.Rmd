...
Like Zach, I'm not good at Regex so I'm just going to add examples that I previously used in my projects. See this [cheatsheet](https://evoldyn.gitlab.io/evomics-2018/ref-sheets/R_strings.pdf) or this [cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/regex.pdf) for some useful guidance I wish I new. 
